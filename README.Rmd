...
The goal of Ex1 is to draw density plots for the parameters listed in 
  cancer_sample data set and use different diagnosis types as facets to separate them

## Installation

Ex1 is not yet on CRAN. But you can download it from the repository using the following R command.
...
This package is special because it will return error if the second object entered is not character, or the third object entered is not numeric value
```{r, error=TRUE}
#Example 1
